(function () {
    ...
    const drivers = {
        ...
        "Light (Group 3)":  { "stats": [2, 2, 2, 2, 5, 1, 8, 8, 8, 8, 4, 5, 6], "parts": ["Baby Mario", "Baby Luigi", "Dry Bones", "Mii (Light)"] },
        "Light (Group 4)":  { "stats": [3, 3, 3, 3, 4, 2, 8, 8, 8, 8, 5, 4, 5], "parts": ["Koopa Troopa", "Lakitu", "Bowser Jr."] },
        "Light (Group 5)":  { "stats": [3, 3, 3, 3, 5, 2, 7, 7, 7, 7, 2, 4, 5], "parts": ["Toadette", "Wendy", "Isabelle"] },
        "Light (Group 6)":  { "stats": [4, 4, 4, 4, 4, 3, 7, 7, 7, 7, 4, 4, 4], "parts": ["Toad", "Shy Guy", "Larry"] },
        "Medium (Group 1)": { "stats": [5, 5, 5, 5, 4, 3, 6, 6, 6, 6, 3, 3, 4], "parts": ["Cat Peach", "Inkling Girl", "Villager (Female)"] },
        "Medium (Group 2)": { "stats": [6, 6, 6, 6, 3, 4, 5, 5, 5, 5, 3, 4, 3], "parts": ["Peach", "Daisy", "Yoshi", "Birdo"] },
        "Medium (Group 3)": { "stats": [6, 6, 6, 6, 3, 5, 5, 5, 5, 5, 1, 3, 3], "parts": ["Tanooki Mario", "Inkling Boy", "Villager (Male)"] },
        "Medium (Group 4)": { "stats": [7, 7, 7, 7, 2, 6, 4, 4, 4, 4, 2, 3, 3], "parts": ["Mario", "Ludwig", "Mii (Medium)"] },
        "Medium (Group 5)": { "stats": [7, 7, 7, 7, 2, 6, 5, 5, 5, 5, 1, 3, 3], "parts": ["Luigi", "Iggy"] },
        "Heavy (Group 1)":  { "stats": [8, 8, 8, 8, 1, 7, 3, 3, 3, 3, 3, 2, 2], "parts": ["Rosalina", "King Boo", "Link"] },
        "Heavy (Group 2)":  { "stats": [8, 8, 8, 8, 1, 10, 3, 3, 3, 3, 1, 1, 1], "parts": ["Metal Mario", "Pink Gold Peach"] },
        "Heavy (Group 3)":  { "stats": [9, 9, 9, 9, 1, 8, 2, 2, 2, 2, 0, 1, 1], "parts": ["Waluigi", "Donkey Kong", "Roy"] },
        "Heavy (Group 4)":  { "stats": [10, 10, 10, 10, 0, 9, 1, 1, 1, 1, 1, 0, 1], "parts": ["Wario", "Dry Bowser" ]},
        "Heavy (Group 5)":  { "stats": [10, 10, 10, 10, 0, 10, 0, 0, 0, 0, 0, 0, 1], "parts": ["Bowser", "Morton", "Mii (Heavy)" ]}
    };

    const bodies = {
        "Body (Group 1)":  { "stats": [0, 1, 1, 2, 7, 0, 5, 4, 4, 5, 4, 7, 0], "parts": ["Biddybuggy", "Mr. Scooty"] },
        "Body (Group 2)":  { "stats": [1, 5, 2, 0, 6, 0, 4, 5, 3, 2, 6, 6, 2], "parts": ["Streetle"] },
        "Body (Group 3)":  { "stats": [1, 5, 2, 0, 6, 0, 4, 5, 3, 2, 6, 6, 1], "parts": ["Landship"] },
        "Body (Group 4)":  { "stats": [1, 3, 1, 1, 6, 1, 5, 4, 2, 4, 4, 6, 2], "parts": ["Pipe Frame"] },
        "Body (Group 5)":  { "stats": [1, 3, 1, 1, 6, 1, 5, 4, 2, 4, 4, 6, 1], "parts": ["Varmint", "City Tripper"] },
        ...
        "Body (Group 15)": { "stats": [2, 4, 3, 3, 2, 3, 4, 4, 3, 3, 7, 4, 4], "parts": ["Tanooki Kart"] },
        "Body (Group 16)": { "stats": [2, 4, 3, 3, 2, 3, 4, 4, 3, 3, 7, 4, 3], "parts": ["Koopa Clown", "Master Cycle Zero"] },
        ...
        "Body (Group 26)": { "stats": [5, 1, 2, 4, 1, 3, 1, 1, 0, 2, 1, 2, 6], "parts": ["Circuit Special", "B Dasher", "P-Wing"] },
        "Body (Group 27)": { "stats": [5, 2, 1, 3, 0, 4, 0, 1, 0, 1, 5, 1, 7], "parts": ["Badwagon", "GLA"] },
        "Body (Group 28)": { "stats": [5, 2, 1, 3, 0, 4, 0, 1, 0, 1, 5, 1, 6], "parts": ["Standard ATV"] }
    };
    ...
    const tires = {
        ...
        "Tire (Group 8)":  { "stats": [2, 2, 1, 2, 2, 4, 0, 1, 1, 0, 7, 3, 5], "parts": ["Monster", "Hot Monster"] },
        "Tire (Group 9)":  { "stats": [2, 2, 1, 2, 2, 4, 0, 1, 1, 0, 7, 3, 4], "parts": ["Ancient Tires"] },
        "Tire (Group 10)": { "stats": [3, 4, 1, 2, 3, 3, 1, 1, 2, 2, 6, 2, 6], "parts": ["Off-Road", "Retro Off-Road"] },
        "Tire (Group 11)": { "stats": [3, 4, 1, 2, 3, 3, 1, 1, 2, 2, 6, 2, 5], "parts": ["Triforce Tires"] },
        "Tire (Group 12)": { "stats": [4, 3, 2, 1, 0, 4, 2, 2, 0, 1, 2, 1, 5], "parts": ["Metal"] },
        "Tire (Group 13)": { "stats": [4, 3, 2, 1, 0, 4, 2, 2, 0, 1, 2, 1, 4], "parts": ["Gold Tires"] },
        "Tire (Group 14)": { "stats": [4, 0, 0, 4, 1, 3, 2, 0, 1, 2, 0, 1, 4], "parts": ["Slick", "Cyber Slick"] }
    };
